...
- The auth-kit wall-clock figures in the `v0.86`–`v0.92` notes predate
  physical-lib-by-default and are not comparable to any current measurement.

---

## v0.60 – v1.2.5 milestone log (historical)
...
## v0.84 Real-Project Audit (historical)
