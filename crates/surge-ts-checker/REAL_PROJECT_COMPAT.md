...
- v1.2.5 is a performance pass after v1.2.4, not a new TypeScript semantic
  ...
  memoized per run in both `surge-ts-checker` (`paths.rs`,
  `canonicalize_if_exists_string`) and `surge-ts-config` (`paths.rs`,
