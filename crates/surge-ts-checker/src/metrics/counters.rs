...
pub(crate) struct ProgramCounters {
    ...
    pub(crate) lazy_reference_placeholder_deferral_count: u64,
    ...
    pub(crate) lazy_intersection_share_count: u64,
    ...
    pub(crate) program_memo_hit_count: u64,
    pub(crate) program_memo_miss_count: u64,
    pub(crate) program_memo_store_count: u64,
    ...
    pub(crate) member_cache_ext_not_check_phase_count: u64,
    pub(crate) member_cache_ext_not_library_scoped_count: u64,
    pub(crate) member_cache_ext_template_unavailable_count: u64,
    pub(crate) member_cache_ext_keyed_count: u64,
