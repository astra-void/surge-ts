...
pub(crate) use values::{
    AutoArrayBinding, DestructureKey, FunctionSignatureInfo, InferredPredicate, SymbolInfo,
    SymbolInfoHandle, SymbolKind, SymbolTable, TupleDestructureBinding, clone_symbol_info_handle,
    map_symbol_kind,
};
