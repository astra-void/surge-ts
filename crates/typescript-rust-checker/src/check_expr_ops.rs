...
use typescript_rust_syntax::{
    ParsedBinaryOperator, ParsedUnaryOperator, TextSpan as SyntaxTextSpan,
};
...
pub(crate) fn evaluate_unary_expression(
    ...
    match operator {
        ...
        ParsedUnaryOperator::Plus | ParsedUnaryOperator::Minus => {
            ...
            if matches!(operand_type, Type::Number) {
...
fn evaluate_add_binary(
    ...
    match (left_type, right_type) {
        ...
        | (Type::Number, Type::String) => InferredExpression::Known(Type::String),
        (Type::Number, Type::Number) => InferredExpression::Known(Type::Number),
        _ => {
            let file_name = ctx.file_name.clone();
            push_diagnostic(
                ctx,
...
fn is_comparison_operand_valid(ty: &Type) -> bool {
    matches!(ty, Type::Number | Type::String | Type::Any)
}
...
fn types_overlap_for_equality(left: &Type, right: &Type) -> bool {
    match (left, right) {
        ...
        (Type::Object(_), Type::Function(_)) | (Type::Function(_), Type::Object(_)) => false,
        (Type::String, Type::Number)
        ...
        | (Type::String, Type::Object(_))
        | (Type::Object(_), Type::String)
        | (Type::String, Type::Function(_))
        | (Type::Function(_), Type::String)
        | (Type::Number, Type::Object(_))
        | (Type::Object(_), Type::Number)
        | (Type::Number, Type::Function(_))
        | (Type::Function(_), Type::Number)
        | (Type::Boolean, Type::Object(_))
        | (Type::Object(_), Type::Boolean)
        | (Type::Boolean, Type::Function(_))
        | (Type::Function(_), Type::Boolean) => false,
        _ => true,
    }
}
